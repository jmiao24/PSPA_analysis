---
title: "POP-INf Simulation: Summarizing OLS Coefficient Estimation Results"
params:
...
write.csv(df_bias, file = paste0(params$output_path, "../ols_df_bias.csv"), row.names = FALSE)
write.csv(df_plot, file = paste0(params$output_path, "../ols_df_plot.csv"))
```
